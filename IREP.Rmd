...
if (!file.exists(sirene_destfile)) {
  ...
  unzip(sirene_destfile, unzip = getOption("unzip"), exdir=data_dir)
...
# ...And only in SIRENE entries associated with these establishments
...
base_sirene <- base_sirene %>% select(-codeCedexEtablissement)
...
establishments_sirene <- establishments %>%
  left_join(base_sirene, by = c("Numero_SIRET" = "siret")) %>%
...
d[d$Identifiant == "051.00692", 'code_postal'] = "51100"
d[d$Identifiant == "063.01580", 'code_postal'] = "49420"
d[d$Identifiant == "065.06453", 'code_postal'] = "93400"
